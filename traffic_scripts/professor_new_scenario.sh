...
./wrk -D exp -t 5 -c 10 -d 120 -L -s ./scripts/social-network/compose-post.lua http://localhost:8080/wrk2-api/post/compose -R 10 & ./wrk -D exp -t 5 -c 10 -d 120 -L -s ./scripts/social-network/read-home-timeline.lua http://localhost:8080/wrk2-api/home-timeline/read -R 10 & ./wrk -D exp -t 5 -c 10 -d 120 -L -s ./scripts/social-network/read-user-timeline.lua http://localhost:8080/wrk2-api/user-timeline/read -R 10 & python3 /home/ubuntu/thesis/sujathesis/traffic_scripts/normal_login_registration_traffic.py
